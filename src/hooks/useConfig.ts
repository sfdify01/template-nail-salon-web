...
const configData: Config = {
  name: "Tabsy Nails",
  tagline: "Professional nail care and beauty.",
  ...
  seo: {
    title: "Tabsy Nails | Premium Halal Meats & Groceries | Online Ordering",
    description: "Shop Tabsy Nails for premium halal meats and groceries. Professional nail care and beauty. Order online for pickup or delivery today.",
