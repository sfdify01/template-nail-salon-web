...
import { CheckCircle2, Package, Home, Clock, MapPin } from 'lucide-react';
...
export const CheckoutStepConfirmation = ({
  ...
  return (
    ...
    >
      {/* Header - Fixed */}
      <header className="flex-shrink-0 bg-gradient-to-br from-green-50 to-emerald-50 border-b border-green-100 py-6 px-4">
