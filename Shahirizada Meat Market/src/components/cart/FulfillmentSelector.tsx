...
export const FulfillmentSelector = ({
  ...
  return (
    <div className="space-y-3">
      <label className="text-xs text-gray-500 font-medium">Fulfillment</label>
      ...
      {selected === 'pickup' && (
        <motion.div 
          ...
          className="text-xs text-green-600 font-medium text-center py-1.5 px-2 bg-green-50 rounded-lg"
        >
          ✓ No delivery fee
        </motion.div>
      )}
